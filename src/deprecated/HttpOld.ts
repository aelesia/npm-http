...
export default class Http {
  ...
  private set _content_type(body: Body) {
    switch (body) {
      case Body.FORM:
        this._headers = { ...{}, ...this._headers, ...{ [H.ContentType]: 'application/x-www-form-urlencoded' } }
        break
      case Body.JSON:
  ...
  async get<Resp>(): Promise<AxiosResponse<Resp>> {
    ...
    return myaxios.get<Resp>(http._url, { params: http._params, headers: http._headers })
  }
  ...
  async post<Resp>(): Promise<AxiosResponse<Resp>> {
    ...
    return myaxios.post(http._url, body, { headers: http._headers })
  }
